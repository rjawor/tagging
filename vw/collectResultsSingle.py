...
print "config: %s\n" % sys.argv[2]
print "total words: %d, right: %d, accuracy: %.4f%%" % (stats['total'], stats['right'], getPercentage(stats['right'], stats['total'])[1])
print renderPRF(getPRFstats(stats['TP'], stats['FP'], stats['FN']))
